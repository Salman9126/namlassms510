      ...
      <div class="vd_top-menu-wrapper">
        <div class="container ">
          ...
          <div class="vd_panel-header">
          	<div class="logo">
            	<a href="<?php echo base_url();?>assets/backend/index.html"><img alt="logo" src="<?php echo base_url();?>assets/backend/img/logo.png"></a>
            </div>
            <!-- logo -->
            ...
            <div class="vd_panel-menu visible-sm visible-xs">
                	<span class="menu visible-xs" data-action="submenu">
                        ...
                        <span class="menu visible-sm visible-xs" data-action="toggle-navbar-right" style="display:none !important;">
...
<div class="vd_menu-search" style="display:none;">
  <form id="search-box" method="post" action="#">
    ...
    <li id="top-menu-1" class="one-icon mega-li">
      <a href="<?php echo base_url();?>assets/backend/index.html" class="mega-link" data-action="click-trigger">
      ...
      <div class="vd_mega-menu-content width-xs-3 width-sm-4 width-md-5 right-xs left-sm" data-action="click-target">
        <div class="child-menu">
           ...
           <div data-rel="scroll">
               <ul class="list-wrapper">
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar.jpg"></div>
                         </a>
                    ...
                    <li class="warning">
                    		<a href="#">
                    			<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-2.jpg"></div>
                            </a>
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-3.jpg"></div>
                         </a>
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-4.jpg"></div>
                         </a>
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-5.jpg"></div>
                         </a>
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-6.jpg"></div>
                         </a>
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-7.jpg"></div>
                         </a>
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar-8.jpg"></div>
                         </a>
        ...
        <div class="child-menu">
		   ...
		   <div class="content-list">
               ...
               <ul  class="list-wrapper pd-lr-10">
                    ...
                    <li> <a href="#">
                    		<div class="menu-icon vd_green"><img alt="example image" src="<?php echo base_url();?>assets/backend/img/avatar/avatar.jpg"></div>
    ...
    <li id="top-menu-profile" class="profile mega-li">
        <a href="#" class="mega-link"  data-action="click-trigger">
            <span  class="mega-image">
                <img src="<?php echo base_url();?>assets/backend/img/avatar/avatar.jpg" alt="example image" />
            </span>
        ...
        <div class="child-menu">
        	<div class="content-list content-menu">
                <ul class="list-wrapper pd-lr-10">
                    ...
                    <li> <a href="<?php echo base_url('admin/dashboard/logout');?>"> <div class="menu-icon"><i class=" fa fa-sign-out"></i></div>  <div class="menu-text">Sign Out</div> </a> </li>
                </ul>
            </div>
        </div>
      </div>
